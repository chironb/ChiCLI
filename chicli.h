...
#define MAX_LENGTH_COMMAND 80 	      // Commodore DOS maximum length of filenames is 16 characters, but we also want quotes around the string, so we add two characters for that // fuck it make it 40 
...
#define MAX_ALIAS_LENGTH 50  	      // This is the number of characters in length any alias can be. This also takes up a lot of RAM!
...
#define MAX_HOTKEY_LENGTH 50 	      // This is the number of characters in length any hotkeys can be. This also takes up a lot of RAM!
/*-------------16--20---25---30--------40--------50---55---60------------------80--------------------*/
// 47
// // ****************************
